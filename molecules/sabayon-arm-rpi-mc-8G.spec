...
%env source_chroot: ${SABAYON_MOLECULE_HOME:-/sabayon}/sources/rpi-mc

# Release desc (the actual release description)
release_desc: armv7l RPi
...
# produced otherwise)
%env image_name: Sabayon_Linux_${SABAYON_RELEASE:-11}_armv7l_RPi_MediaCenter_8GB.img
...
%env source_boot_directory: ${SABAYON_MOLECULE_HOME:-/sabayon}/boot/arm/rpi
